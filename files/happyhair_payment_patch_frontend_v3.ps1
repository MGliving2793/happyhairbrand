<#
Patch script (frontend v3) — creates/overwrites the three frontend files changed: Checkout.jsx, UPIAutoClaim.jsx, UPIQr.jsx
Run from project root:
  cd "C:\Users\HP\Documents\final web"
  powershell -ExecutionPolicy Bypass -File .\files\happyhair_payment_patch_frontend_v3.ps1
#>
